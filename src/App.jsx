...
function App() {
  return (
    <>
      ...
      <div className="shadow-lg p-5 w-4xl my-auto mx-auto">

        <Form/>
        {/* m - mx, my, mr, ml , mt, mb, auto */}
        {/* p - px, py, pr, pl , pt, pb, auto */}
        {/* round - rounder-value */}
        {/* size - sm(small) md(medium) lg(large) xl(extra large) */}
        {/* widht - w-value | w-full */}
        {/* height - h-value */}

         <h1 className="text-5xl text-blue-900 font-mono text-center my-5">Tailwind Fundamentals</h1>
         <button className="rounded-4xl bg-blue-500 text-white px-5 py-2 mx-80 my-5">Click</button>

          {/*f Flexbox  */}
          <div className="flex gap-4">
              <h1 className="text-5xl text-blue-900 font-mono my-5">Tailwind Fundamentals</h1>
          ...
          <div className="grid grid-cols-2 gap-2">
              <h1 className="text-5xl text-blue-900 font-mono my-5">Tailwind Fundamentals</h1>
              <button className="rounded-4xl bg-blue-500 text-white px-5 py-2 my-5 hover:bg-blue-400">Flex Button</button>
              <button className="rounded-4xl bg-blue-500 text-white px-5 py-2 my-5 col-span-1  hover:bg-blue-400">Flex Button</button>
              <button className="rounded-4xl bg-blue-500 text-white px-5 py-2 my-5  hover:bg-blue-400">Flex Button</button>
          </div>
